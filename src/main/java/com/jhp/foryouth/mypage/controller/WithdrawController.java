...
import com.jhp.foryouth.mypage.dto.WithdrawRequest;
...
public class WithdrawController {
    ...
    public ResponseEntity<?> withdrawUser(@RequestBody WithdrawRequest request, HttpServletRequest httpRequest) {
        ...
        userInfoService.withdraw(userId, provider, email, request.getReason());
